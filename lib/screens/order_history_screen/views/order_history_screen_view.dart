                  ...
                  child: CircularProgressIndicator(),
                    ...
                    : Column(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 20,bottom: 10,right: 15),
                          child: Row(
                            children: [
                              Expanded(
                                child: Padding(
                              ...
                              Row(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Icon(Icons.filter_list,size: 15,color: AppColors.black,),
                                  )
                                ],
                              )
                            ],
                        ...
                        Flexible(
                          child: SizedBox(
                            ...
                            child: SingleChildScrollView(
                              child: GetBuilder<OrderHistoryScreenController>(
                                builder: (OrderHistoryScreenController) => Expanded(
                                  child: controller.isProductLoader.value
                                      ...
                                      itemBuilder: (context, index) {
                                        return GestureDetector(
                                          ...
                                          // },
                                          child: Container(
                                            padding:  EdgeInsets.only(left: 14, bottom: 12, top: 29,right: 14),
                                            height: 130,
                                            width: Get.width,
                                            child: Row(
                                              children: [
