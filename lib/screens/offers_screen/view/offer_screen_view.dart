...
class OffersView extends GetView<OffersController> {
        ...
        child: Container(
          ...
          child: GetBuilder<OffersController>(
            builder: (OffersController) => controller
                ...
                : controller.products.value.length > 0
                    ? ListView.separated(
  ...
  Widget offersEmptyDesign(context) {
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Center(
            child: Text(
              "No offers available. Come back later to check for new offers",
