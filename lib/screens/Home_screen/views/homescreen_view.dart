              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              SizedBox(
                                ...
                                child: CarouselSlider.builder(
                                    ...
                                    itemBuilder: (context, index, realIndex) {
                                      return homeController.carouselLoader.value
                                      ?
                                      Container(
                                      margin: EdgeInsets.symmetric(horizontal: 15),
                                      ...
                                      margin: EdgeInsets.symmetric(horizontal: 15),
                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),
                                      image: DecorationImage(image: NetworkImage(controller.carousel[index].image.toString()),fit: BoxFit.
                                      fill
                                      )
                                      ,
                                      )
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 15),
                      child: TextWidget("Shop by Category", fontSize: 16,
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 15),
                      child: TextWidget("Best Sellers", fontSize: 14,
                        fontWeight: FontWeight.w600,),
                    ),
                    AppSize.size.h15,
                    GetBuilder<HomeScreenController>(
