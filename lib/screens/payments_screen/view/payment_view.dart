                        ...
                        children: [
                            ...
                            child: SizedBox(
                              ...
                              child: Checkbox(
                                ...
                                side: MaterialStateBorderSide.resolveWith(
                                  (states) => BorderSide(
                                      width: 0.75, color: Color(0xffC0BEBE)),
                                ),
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              width: Get.width / 1.4,
                              child: Html(
                                data: controller.paymentMethod.value
                                    .paymentMethods?.ccavenuepay?.title,
                              ),
                            ),
                          )
                        ],
                    ...
                    Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding:
                                  const EdgeInsets.only(left: 19.0, top: 28),
                              child: SizedBox(
                                height: 24.0,
                                width: 24.0,
                                child: Checkbox(
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(left: 12, top: 32.0),
                              child: SizedBox(
                                height: 61,
                                width: Get.width / 1.4,
                                child: Text((controller.paymentMethod.value
                                    .paymentMethods?.cod.title)!),
                              ),
                            )
                          ],
                        )),
