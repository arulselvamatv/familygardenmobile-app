              ...
              child: Obx(
                  ...
                  appBarActions: GestureDetector(
                    onTap: () async {
                      ...
                      for(var i = 0;i<(controller.products.value.length); i++){
                        controller.cartBoolList.value[i] = false;
                        controller.counterList.value[i] = 1;
                      }
                      int vals = await controller.hitAddCartAPI();
                      if (vals == 0) {
                        print("value : $vals");
                        Get.toNamed(Routes.CART_SCREEN)?.then((value) {
                          ...
                          controller.getCartCount();
                          print("Scroll psotiiton${controller.scrolledPosition.value}");
                        });
                      }
                     controller. update();
                    },
